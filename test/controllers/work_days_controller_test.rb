...
class WorkDaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create work_day" do
    assert_difference('WorkDay.count') do
      post work_days_url, params: { work_day: { employee_id: @work_day.employee_id, end_time: @work_day.end_time, start_time: @work_day.start_time } }
    end
  ...
  test "should update work_day" do
    patch work_day_url(@work_day), params: { work_day: { employee_id: @work_day.employee_id, end_time: @work_day.end_time, start_time: @work_day.start_time } }
